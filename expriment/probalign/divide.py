...
for _filename in files:
    ...
    if empty_flag_1.count(0) == 1:
        ...
        #Generate aligned file using probalign
        os.system("probalign "  + _out_file_path + "in_pt1/" + originalfname + "_pt1 >> " + pt0_outpath + originalfname + "_pt1_aligned ")
    ...
    if empty_flag_2.count(0) == 1:
        ...
        #Generate aligned file using probalign
        os.system("probalign "  + _out_file_path + "in_pt2/" + originalfname + "_pt2 >> " + pt0_outpath + originalfname + "_pt2_aligned ")
